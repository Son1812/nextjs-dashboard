  ...
  return (
    ...
    >
      ...
      <Menu
        ...
        renderExpandedMenuItemIcon={{ icon: <i className='' /> }}
        menuSectionStyles={menuSectionStyles(theme)}
      >
        <MenuItem href='/' icon={<i className='ri-home-smile-line' />}>
          Dashboards
        </MenuItem>
        <SubMenu label='Connections' icon={<i className='ri-link' />}>
          <MenuItem href='/connections/connections'>Connections</MenuItem>
          <MenuItem href=''>Scource</MenuItem>
          <MenuItem href=''>Distination</MenuItem>
          <MenuItem href=''>Health</MenuItem>
        </SubMenu>
        {/* <SubMenu
          label='Front Pages'
